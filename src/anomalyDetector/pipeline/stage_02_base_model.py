...
class BaseModelTrainingPipeline:
    def __init__(self, start, end, site_code, closing_hour_week, opening_hour_week, threshold, margin, closing_hour_sun, opening_hour_sun):
        self.start = start
        self.end = end 
    ...
    def main(self):
        ...
        base_model = BaseModel(self.start, self.end, self.site_code, self.closing_hour_week, self.opening_hour_week, self.threshold, self.margin, self.closing_hour_sun, self.opening_hour_sun, config=base_model_config)
        base_model.DETECT()
